...
spades.py -1 $2/FASTQs/$1_R1.fastq -2 $2/FASTQs/$1_R2.fastq \
    --meta -t 32 -m 360 -o $2/META-ASM/$1
conda deactivate
...
minimap2 -t 32 -N 5 -ax sr $2/META-ASM/$1/VAMB/$1.catalogue.mmi --split-prefix mmsplit \
	 $2/FASTQs/$1_R1.fastq $2/FASTQs/$1_R2.fastq | samtools view -F 3584 -b --threads 32 > $2/META-ASM/$1/VAMB/$1.bam
vamb --outdir $2/META-ASM/$1/VAMB/VAMB-OUT --fasta $2/META-ASM/$1/VAMB/$1.catalogue.fna.gz --bamfiles $2/META-ASM/$1/VAMB/$1.bam \
